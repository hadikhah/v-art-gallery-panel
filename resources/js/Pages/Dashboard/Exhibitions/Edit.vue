...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-4">
            <div
                class="max-w-full sm:px-6 flex flex-col md:flex-row flex-wrap align-center items-stretch justify-around">
                <div class="bg-white sm:p-4 p-8 md:me-2 my-2 shadow max-h-fit sm:rounded-lg flex-auto md:w-4/12">
                    <UpdateExhibitionInformationForm :exhibition="exhibition" :statusList="statusList" />
                </div>

                <div class="bg-white sm:p-4 p-8 my-2 shadow sm:rounded-lg flex-none  overflow-auto md:w-7/12">
                    <Deferred :data="['allUserImages']">
                        <template #fallback>
                            <Skeleton :count="5"></Skeleton>
                        </template>
                        <AttachExhibitionImages :allUserImages :exhibitionImages :userImagePage :exhibition>
                    ...
                    <Deferred :data="['exhibitionImages']">
                        ...
                        <ExhibitionImages :exhibitionImages :exhibition></ExhibitionImages>
                    </Deferred>
                </div>
