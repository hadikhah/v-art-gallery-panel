            ...
            >
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('home', { lang: locale })">
                                    <ApplicationLogo
                            ...
                            >
                                ...
                                <NavLink
                                    :href="
                                        route('exhibitions', { lang: locale })
                                    "
                                    :active="route().current('exhibitions')"
                                    prefetch
                                >
                                    Exhibitions
                                </NavLink>
                            ...
                            <button
                                @click="
                                    showingNavigationDropdown =
                                        !showingNavigationDropdown
                                "
                                class="inline-flex mx-2 items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none dark:hover:bg-gray-700 dark:hover:text-gray-200"
                            >
                                <svg
                                    class="h-6 w-6"
                                    stroke="currentColor"
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            :href="route('exhibitions', { lang: locale })"
                            :active="route().current('exhibitions')"
                        >
                            Exhibitions
                        </ResponsiveNavLink>
